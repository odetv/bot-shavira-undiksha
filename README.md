# BOT SHAVIRA (GANESHA VIRTUAL ASSISTANT)
...
```bash
  https://github.com/odetv/bot-shavira-undiksha.git
```

Masuk ke direktori project

```bash
  cd bot-shavira-undiksha
```
...
Jalankan di server development/production/deployment
